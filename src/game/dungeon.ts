...
const ENEMY_TABLE = [
  ...
  { name: 'ちびコウモリ',    minFloor: 1,  maxFloor: 5,  hpBase: 5,  atkBase: 3,  defBase: 0,  str:  1, vit:  0, agi: 10, luk:  3 },
  { name: 'プチラット',      minFloor: 1,  maxFloor: 6,  hpBase: 7,  atkBase: 2,  defBase: 0,  str:  2, vit:  0, agi:  8, luk:  2 },
  { name: 'アントワーカー',  minFloor: 3,  maxFloor: 10, hpBase: 10, atkBase: 4,  defBase: 1,  str:  5, vit:  3, agi:  8, luk:  1 },
  { name: 'ポイズンバグ',    minFloor: 4,  maxFloor: 12, hpBase: 8,  atkBase: 5,  defBase: 1,  str:  4, vit:  1, agi:  8, luk:  3 },
  { name: 'スティングビー',  minFloor: 5,  maxFloor: 15, hpBase: 9,  atkBase: 6,  defBase: 1,  str:  3, vit:  1, agi: 12, luk:  4 },
  { name: 'マンドレイク',    minFloor: 6,  maxFloor: 15, hpBase: 14, atkBase: 5,  defBase: 2,  str:  6, vit:  4, agi:  3, luk:  1 },
  { name: 'アクアスライム',  minFloor: 7,  maxFloor: 16, hpBase: 12, atkBase: 6,  defBase: 2,  str:  5, vit:  5, agi:  4, luk:  2 },
  { name: 'パラサイトバイン',minFloor: 8,  maxFloor: 18, hpBase: 16, atkBase: 6,  defBase: 3,  str:  7, vit:  4, agi:  5, luk:  2 },
  { name: 'グレムリン',      minFloor: 10, maxFloor: 22, hpBase: 18, atkBase: 8,  defBase: 3,  str:  8, vit:  3, agi: 10, luk:  5 },
  { name: 'ダークシーフ',    minFloor: 12, maxFloor: 25, hpBase: 16, atkBase: 10, defBase: 2,  str: 10, vit:  2, agi: 15, luk:  6 },
  { name: 'アイアンナイト',  minFloor: 15, maxFloor: 30, hpBase: 24, atkBase: 9,  defBase: 5,  str: 12, vit: 10, agi:  5, luk:  2 },
  { name: 'ボーンウォーカー',minFloor: 15, maxFloor: 35, hpBase: 20, atkBase: 10, defBase: 4,  str: 10, vit:  6, agi:  5, luk:  3 },
  { name: 'ゴーストナイト',  minFloor: 18, maxFloor: 40, hpBase: 18, atkBase: 13, defBase: 3,  str: 14, vit:  3, agi: 10, luk:  4 },
  { name: 'リッチ',          minFloor: 22, maxFloor: 99, hpBase: 28, atkBase: 14, defBase: 5,  str: 16, vit:  6, agi:  6, luk:  5 },
  { name: 'デビルウィング',  minFloor: 25, maxFloor: 99, hpBase: 30, atkBase: 16, defBase: 6,  str: 18, vit:  5, agi: 14, luk:  7 },
  { name: 'シャドウデーモン',minFloor: 30, maxFloor: 99, hpBase: 35, atkBase: 18, defBase: 7,  str: 22, vit:  8, agi: 10, luk:  8 },
  { name: 'ワイバーン',      minFloor: 35, maxFloor: 99, hpBase: 40, atkBase: 20, defBase: 8,  str: 25, vit: 15, agi: 12, luk:  6 },
  { name: 'ドレイク',        minFloor: 45, maxFloor: 99, hpBase: 50, atkBase: 25, defBase: 10, str: 30, vit: 20, agi: 15, luk:  8 },
]
