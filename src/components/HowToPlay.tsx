        ...
        <div className="htp-body">
          ...
          <Section icon="🛡️" title="装備と「あるかなひろば」">
            ...
            <ul className="htp-list">
              ...
              <li>🛒 <b>行商人</b> … 🪙女神のコインと引き換えに<b>羽アイテム</b>を購入（各10個まで）</li>
            </ul>
            <p className="htp-note">羽は緊急脱出・移動に便利です。🪰<b>ハエの羽</b>＝同じ階のどこかへワープ／🦋<b>蝶の羽</b>＝1〜3階ぶん前の階層へ戻る。ただし<b>一度踏破した階へ戻ると、その階では経験値もアイテムも一切得られません</b>（同じ場所での無限レベル上げ防止）。回復の泉などの仕掛けは通常どおり使えます。</p>
          </Section>
