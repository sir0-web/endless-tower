      ...
      <div className="htp-panel" onClick={e => e.stopPropagation()}>
        ...
        <div className="htp-body">
          ...
          <Section icon="🏹" title="弓（レンジ武器）">
            ...
            <p>射程内なら隣接しなくても攻撃可能。マップ右下の <b>🏹</b> ボタン、または <Key>Space</Key> キーでその場から矢を放てます（移動せずターン消費）。狙いは<b>今向いている方向</b>が優先されるので、撃ちたい敵の方をあらかじめ向いておきましょう（壁に向かって移動キーを押すだけでも向きだけ変えられます）。</p>
