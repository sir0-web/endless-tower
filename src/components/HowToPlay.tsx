      ...
      <div className="htp-panel" onClick={e => e.stopPropagation()}>
        ...
        <div className="htp-body">
          ...
          <Section icon="🏹" title="弓（レンジ武器）">
            ...
            <p className="htp-note">敵が隣接する前の本当の遠距離弾には<b>不意打ちボーナス（威力+30%）</b>が乗ります。逆に<b>隣接した敵への弓攻撃は威力半減</b>（近すぎて引き絞れない）。さらに矢を1回放つごとに<b>スタミナを5消費</b>します。「離れて先制するなら弓、詰められたら・スタミナを節約したいなら剣」が使い分けの基本です。命中率は距離が離れるほど下がるので過信は禁物です。</p>
          </Section>
