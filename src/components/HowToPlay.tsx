      ...
      <div className="htp-panel" onClick={e => e.stopPropagation()}>
        ...
        <div className="htp-body">
          ...
          <Section icon="🎒" title="アイテム">
            ...
            <ul className="htp-list">
              <li>💊 <b>ポーション</b> … HPやスタミナを回復</li>
              <li>📖 <b>魔法の書</b> … ファイアボルト・ブレッシング・メテオストームなど（INTで威力UP）</li>
              <li>⚔️ <b>装備品</b> … 7部位に装備して能力強化</li>
              <li>🪙 <b>女神のコイン</b> … 敵撃破時に約20%でドロップ。使うと<b>スロットを1回まわせる</b>幸運の証</li>
            </ul>
          </Section>
          ...
          <Section icon="🛡️" title="装備と「あるかなひろば」">
            ...
            <ul className="htp-list">
              <li>🔨 <b>精錬</b> … 装備を生贄に、武具を <b>+1, +2…</b> と強化（成功率あり）</li>
          ...
          <Section icon="👑" title="ボス">
            ...
            <ul className="htp-list">
              <li><b>MINIボス</b> … 5階ごと</li>
              <li><b>MVPボス</b> … 10階ごとの強敵</li>
              <li><b>エリアボス</b> … 各エリアの主。出現階はゲームごとに変化</li>
            </ul>
          </Section>

          <Section icon="🎰" title="女神の加護（スロット）">
            <p>右側のスロットは、<b>敵を3体倒すごとに1回</b>自動で回転します（🪙女神のコインでも回せます）。出た役で大きな恩恵が――</p>
            <ul className="htp-list htp-slot">
              <li><b className="htp-accent">777</b> … 超大当たり！ Lv+10・HP/STA上限+10%・<b>全ての敵が消滅</b></li>
              <li><b>ぞろ目</b> … HP/スタミナ全回復＋<b>装備3個</b>獲得</li>
              <li><b>1・2・3</b> … ランダムな装備品をプレゼント</li>
              <li><b>両端そろい</b> … 最大HPの半分を回復</li>
          ...
          <Section icon="🏆" title="ランキングとセーブ">
            <p>力尽きた後、名前を登録して<b>到達階層ランキング</b>に挑戦できます。</p>
            <p>冒険は自動で記録され、タイトルの<b>GAME START</b>から<b>中断データで再開</b>できます。</p>
          </Section>
